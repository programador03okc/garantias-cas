<div class="container-page">
	<div class="row">
		...
		<div class="row">
			<div class="col-md-12">
				<button type="button" class="btn btn-primary btn-sm btn-flat" onclick="openModal('categoria');">
					<span class="icon-plus"></span>Nueva Categoría
				</button>
			</div>
		</div>
		<br>
		<div class="col-md-8">
			<fieldset class="group-form">
				...
				<table class="table table-hover table-bordered table-striped" id="tablaCategoria" width="100%">
					<thead>
						<tr>
							<th width="20">N°</th>
							<th>Descripción</th>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modal-categoria">
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			<form class="formPage" id="formulario" form="categoria" type="register">
